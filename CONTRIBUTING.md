...
## Did you find a bug
*   Ensure the bug was not already reported by searching on GitHub under [Issues](https://github.com/AleXX-XD/repository-template/issues).

*   If you're unable to find an open issue addressing the problem, open a [new one](https://github.com/AleXX-XD/repository-template/issues/new/choose). 
